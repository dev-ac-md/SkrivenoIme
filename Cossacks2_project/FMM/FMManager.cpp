...
таблицы размеров, начиная с индекса, полученного из запрашиваемого размера.
	По нахождении, хендл удаляется из таблицы размеров, и делится на два хендла, в
случае, когда его размер не точно совпал с нужным. Первый (левый) хендл становится 
