...
word GetTopRef(int Ofs, byte TopType=0);		// Ofs = Top
word GetLinksDist(int Ofs, byte TopType=0);	// Ofs = StartTop + FinTop * NAreas
word GetMotionLinks(int Ofs, byte TopType=0);	// Ofs = StartTop + FinTop * NAreas
